...
function checkDarkMode() {
    if (
        localStorage.getItem("my_web_darkmode") !== null &&
        localStorage.getItem("my_web_darkmode") === "true"
    ) {
...
checkbox.addEventListener("change", () => {
    ...
    document.body.classList.contains("dark")
        ? localStorage.setItem("my_web_darkmode", true)
        : localStorage.setItem("my_web_darkmode", false);
});
